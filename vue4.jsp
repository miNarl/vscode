...
<section id="box">
	...
	<span>{{search}}</span>	<!-- v-model 과 같은 이름일 경우 입력한 값을 바로 출력 -->
	<br><br>
...
<form id="f" method="get" action="./vue4.jsp"> <!-- form 은 vue 와 상관없이 사용가능 -->
<section id="box2">
<!-- checkbox, radio 는 value 가 적용되어서 get, post 로 값을 전송할 수 있음 -->
